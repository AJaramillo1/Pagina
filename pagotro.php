...
<head>
  ...
  <form method="POST">
      ...
      <h1 class="text-center" style="color: white" >Bienvenido: USUARIO  </h1> <h1>__</h1> 
      <?php
            ...
            function obUsu($conBD) {
               ...
               if (mysqli_num_rows($res) > 0) {
                  while ($fila = mysqli_fetch_assoc($res)) {
                     $filTa .= "<tr>";
                     $filTa .= "<td>" . $fila["id_libro"] . "</td>";
                     $filTa .= "<td>" . $fila["Nombre"] . "</td>";
                     $filTa .= "<td>" . $fila["Descripcion"] . "</td>";
                     $filTa .= "<td>" . $fila["Precio"] . "</td>";
                     $filTa .= "<td>" . "<button type='button' class='btn btn-success'>Ver</button>" . "</td>";
                     $filTa .= "</tr>";
                  }  
               }
               else {
               ...
               if ($conBD) {
                  ...
                  <div class='border-success'>
                     ...
                     ."<th>Nombre</th>" . "<th>Edad</th>". "<th>Peso</th>". "<th>Ver</th>"."</tr>" .$filas . "  </table>" ."</div>"; echo $tabla;
               }
               else {
